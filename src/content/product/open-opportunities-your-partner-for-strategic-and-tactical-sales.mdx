...
**Chart:** Average contract length by healthcare category (data visualization showing contract durations ranging from 9 months for Clinical forensics equipment to 33 months for Anaesthesia and resuscitation, including categories like Medical consumables, Eye care products, Various medicinal products, and more).
