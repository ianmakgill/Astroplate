(function() {
  ...
  function initializeChart() {
    const data = [
      { category: "Parts of firearms and ammunition", year2022: 31.48, year2024: 828.81 },
      { category: "Individual equipment", year2022: 265.68, year2024: 599.10 },
      { category: "Parts of military vehicles", year2022: 38.78, year2024: 358.33 },
      { category: "Command, control, communication and computer systems", year2022: 15.94, year2024: 305.23  },
      { category: "Parts for warships", year2022: 62.69, year2024: 253.35 },
    ].map(d => ({
      ...d,
    ...
    if (!container) {
      console.error('Container element #healthcare-category-values-slope-2022-2024 not found');
      return;
    }
    ...
    if (!document.getElementById('defence-value-slope-styles')) {
      const styleSheet = document.createElement('style');
      styleSheet.id = 'defence-value-slope-styles';
