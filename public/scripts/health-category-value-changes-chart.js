(function() {
    ...
    function initializeChart() {
        const data = [
            { category: "Medical consumables", year2022: 15.52, year2024: 14.40 },
            { category: "Various medicinal products", year2022: 15.55, year2024: 12.13 },
            { category: "Dental instruments", year2022: 1.80, year2024: 4.20 },
            { category: "Functional support", year2022: 2.67, year2024: 3.72 },
            { category: "General anti-infectives", year2022: 3.96, year2024: 3.29 },
            { category: "Miscellaneous devices", year2022: 5.07, year2024: 3.49 },
            { category: "Imaging equipment", year2022: 2.79, year2024: 2.04 }
        ].map(d => ({
            ...d,
        ...
        const container = document.getElementById('health-category-value-changes');
        if (!container) {
        ...
        const margin = { top: 50, right: 250, bottom: 40, left: 250 };
